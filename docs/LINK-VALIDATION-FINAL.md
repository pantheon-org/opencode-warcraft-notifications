...
[31mBroken Links:[0m
  ...
  [33msrc/content/docs/documentation-map.md[0m
    ...
    Line 37: [31m/schemas[0m
      Reason: File not found
      Target: src/content/docs/schemas.md

    Line 63: [31m/user-guide#faction-selection[0m
      Reason: Anchor not found
      Target: src/content/docs/user-guide.md
      Anchor: #faction-selection

    Line 70: [31m/user-guide#updating-the-plugin[0m
      Reason: Anchor not found
      Target: src/content/docs/user-guide.md
      Anchor: #updating-the-plugin

    Line 92: [31m/architecture#module-dependencies[0m
      Reason: Anchor not found
      Target: src/content/docs/architecture.md
      Anchor: #module-dependencies

    Line 114: [31m/deployment#sound-file-management[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #sound-file-management

    Line 115: [31m/deployment#configuration-management[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #configuration-management

    Line 120: [31m/github-workflows[0m
      Reason: File not found
      Target: src/content/docs/github-workflows.md

    Line 121: [31m/github-workflows/overview#smart-version-bump[0m
      Reason: Anchor not found
      Target: src/content/docs/github-workflows/overview.md
      Anchor: #smart-version-bump

    Line 122: [31m/github-workflows/overview#release-publish[0m
      Reason: Anchor not found
      Target: src/content/docs/github-workflows/overview.md
      Anchor: #release-publish

    Line 123: [31m/github-workflows/overview#auto-merge-bot[0m
      Reason: Anchor not found
      Target: src/content/docs/github-workflows/overview.md
      Anchor: #auto-merge-bot

    Line 129: [31m/deployment#backup-recovery[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #backup-recovery

    Line 142: [31m/onboarding#environment-setup[0m
      Reason: Anchor not found
      Target: src/content/docs/onboarding.md
      Anchor: #environment-setup

    Line 150: [31m/schemas[0m
      Reason: File not found
      Target: src/content/docs/schemas.md
    ...
    Line 151: [31m/deployment#configuration-management[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #configuration-management

    Line 169: [31m/development#test-coverage[0m
      Reason: Anchor not found
      Target: src/content/docs/development.md
      Anchor: #test-coverage

    Line 176: [31m/github-workflows[0m
      Reason: File not found
      Target: src/content/docs/github-workflows.md

    Line 177: [31m/github-workflows[0m
      Reason: File not found
      Target: src/content/docs/github-workflows.md

    Line 178: [31m/deployment#cicd-integration[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #cicd-integration

    Line 184: [31m/troubleshooting#common-issues[0m
      Reason: Anchor not found
      Target: src/content/docs/troubleshooting.md
      Anchor: #common-issues

    Line 197: [31m/user-guide#faction-selection[0m
      Reason: Anchor not found
      Target: src/content/docs/user-guide.md
      Anchor: #faction-selection

    Line 215: [31m/github-workflows[0m
      Reason: File not found
      Target: src/content/docs/github-workflows.md

    Line 217: [31m/deployment#cicd-integration[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #cicd-integration

    Line 297: [31mmailto:support@pantheon-ai.com[0m
      Reason: File not found
  ...
  [33msrc/content/docs/github-workflows/docs-regeneration.md[0m
    ...
    Line 491: [31m./docs-branch-structure.md[0m
      Reason: File not found
      Target: src/content/docs/github-workflows/docs-branch-structure.md

    Line 492: [31m./deploy-docs.md[0m
      Reason: File not found
      Target: src/content/docs/github-workflows/deploy-docs.md

    Line 493: [31m./development.md[0m
      Reason: File not found
  ...
  [33msrc/content/docs/index.md[0m
    ...
    Line 146: [31m/schemas[0m
      Reason: File not found
      Target: src/content/docs/schemas.md

    Line 170: [31m/architecture#sound-data-module[0m
      Reason: Anchor not found
      Target: src/content/docs/architecture.md
      Anchor: #sound-data-module

    Line 194: [31m/architecture#bundled-sounds-module[0m
      Reason: Anchor not found
      Target: src/content/docs/architecture.md
      Anchor: #bundled-sounds-module

    Line 195: [31m/deployment#sound-file-management[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #sound-file-management

    Line 214: [31m/user-guide#updating-the-plugin[0m
      Reason: Anchor not found
      Target: src/content/docs/user-guide.md
      Anchor: #updating-the-plugin

    Line 272: [31m/github-workflows[0m
      Reason: File not found
      Target: src/content/docs/github-workflows.md
  ...
  [33msrc/content/docs/pipeline.md[0m
    ...
    Line 30: [31m#version-update-workflow[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #version-update-workflow

    Line 31: [31m#auto-merge-workflow[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #auto-merge-workflow

    Line 32: [31m#create-tag-workflow[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #create-tag-workflow

    Line 33: [31m#publish-release-workflow[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #publish-release-workflow

    Line 34: [31m#cleanup-workflow[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #cleanup-workflow

    Line 884: [31m${npmUrl}[0m
      Reason: File not found
      Target: src/content/docs/${npmUrl}.md

    Line 1484: [31m./docs/squash-merge-configuration.md[0m
      Reason: File not found
  ...
  [33msrc/content/docs/troubleshooting.md[0m
    ...
    Line 24: [31m/user-guide#wrong-faction-sounds[0m
      Reason: Anchor not found
      Target: src/content/docs/user-guide.md
      Anchor: #wrong-faction-sounds

    Line 27: [31m/user-guide#sound-files-missing[0m
      Reason: Anchor not found
      Target: src/content/docs/user-guide.md
      Anchor: #sound-files-missing

    Line 48: [31m/development#tests-failing[0m
      Reason: Anchor not found
      Target: src/content/docs/development.md
      Anchor: #tests-failing

    Line 79: [31m/deployment#installation-fails[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #installation-fails

    Line 80: [31m/deployment#sound-files-missing[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #sound-files-missing

    Line 81: [31m/deployment#configuration-not-loading[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #configuration-not-loading

    Line 82: [31m/deployment#platform-specific-troubleshooting[0m
      Reason: Anchor not found
      Target: src/content/docs/deployment.md
      Anchor: #platform-specific-troubleshooting

    Line 225: [31m/pipeline#workflow-failures[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #workflow-failures

    Line 226: [31m/pipeline#version-bump-issues[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #version-bump-issues

    Line 227: [31m/pipeline#deployment-failures[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
      Anchor: #deployment-failures

    Line 228: [31m/pipeline#auto-merge-troubleshooting[0m
      Reason: Anchor not found
      Target: src/content/docs/pipeline.md
