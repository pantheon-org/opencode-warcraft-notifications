...
export const letterJ: LetterData = {
  rows: {
    0: [cellType.BLANK, cellType.BLANK, cellType.BLANK],
    1: [cellType.PRIMARY, cellType.PRIMARY, cellType.PRIMARY],
    2: [cellType.BLANK, cellType.BLANK, cellType.PRIMARY],
    3: [cellType.SECONDARY, cellType.SECONDARY, cellType.PRIMARY],
    4: [cellType.PRIMARY, cellType.SECONDARY, cellType.PRIMARY],
