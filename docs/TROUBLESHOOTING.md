...
For common user issues, see [USER_GUIDE.md - Troubleshooting](USER_GUIDE.md#troubleshooting)

### Quick Links

- [No sound playing](USER_GUIDE.md#no-sound-playing)
- [Wrong faction sounds](USER_GUIDE.md#wrong-faction-sounds)
- [Plugin not loading](USER_GUIDE.md#plugin-not-loading)
- [Configuration not loading](USER_GUIDE.md#configuration-not-loading)
- [Sound files missing](USER_GUIDE.md#sound-files-missing)
...
For development issues, see [DEVELOPMENT.md - Debugging](DEVELOPMENT.md#debugging)

### Quick Links

- [Tests failing](DEVELOPMENT.md#tests-failing)
- [Type errors](DEVELOPMENT.md#type-checking)
- [Linting issues](DEVELOPMENT.md#linting)
- [Sound not playing during development](DEVELOPMENT.md#sound-not-playing)
...
- [Installation fails](DEPLOYMENT.md#installation-fails)
- [Sound files missing](DEPLOYMENT.md#sound-files-missing)
- [Configuration issues](DEPLOYMENT.md#configuration-not-loading)
- [Platform-specific issues](DEPLOYMENT.md#platform-specific-troubleshooting)
...
For CI/CD pipeline issues, see [PIPELINE.md - Troubleshooting](PIPELINE.md#troubleshooting)

### Quick Links

- [Workflow failures](PIPELINE.md#workflow-failures)
- [Version bump issues](PIPELINE.md#version-bump-issues)
- [Deployment failures](PIPELINE.md#deployment-failures)
- [Auto-merge issues](PIPELINE.md#auto-merge-troubleshooting)
