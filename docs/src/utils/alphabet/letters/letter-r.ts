 ...
 */
export const letterR: LetterData = {
  rows: {
    ...
    2: [cellType.PRIMARY, cellType.PRIMARY, cellType.PRIMARY, cellType.PRIMARY],
    ...
    5: [cellType.PRIMARY, cellType.SECONDARY, cellType.SECONDARY, cellType.SECONDARY],
